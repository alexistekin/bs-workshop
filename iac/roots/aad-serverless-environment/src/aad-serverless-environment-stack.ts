...
import { NetworkConstruct, AADEnvironmentParams, DynamoDBConstruct, } from '@aws-app-development/common-constructs'
...
export interface AADServerlessEnvStackProps extends cdk.StackProps {
  uniqueEnvIdentifier: string;
}

export class AADServerlessEnvStack extends cdk.Stack {

  constructor(scope: Construct, id: string, props: AADServerlessEnvStackProps) {
    ...
    const provisioningRoleConstruct = new ServerlessAPIProvisioningConstruct(this, `${aadEnvParams.prefix}-${envIdentifier}-provisioning-role`, {
      aadEnv: aadEnvParams,
      KMSkey: key,
    ...
    const operationsRoleConstruct = new ServerlessAPIOperationsConstruct(this, `${aadEnvParams.prefix}-${envIdentifier}-operations-role`, {
      aadEnv: aadEnvParams,
      KMSkey: key,
      vpcCollection: [network.vpc],
