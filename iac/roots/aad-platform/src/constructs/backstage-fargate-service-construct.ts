...
export class BackstageFargateServiceConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: BackstageFargateServiceConstructProps) {
    ...
    const backstageSecret = new Secret(this, `${props.aadEnv.prefix}-backstage-appsecret`, {
      secretName: `${props.aadEnv.prefix}-backstage-appsecret`,
    });
        ...
        `${props.aadEnv.prefix}-backstage`,
        {
          ...
          taskImageOptions: {
            ...
            environment: {
              ...
              BACKSTAGE_TITLE: "AWS Application Development",
              BACKSTAGE_ORGNAME: "AAD",
              PROTOCOL: "https",
        ...
        `${props.aadEnv.prefix}-backstage`,
        {
          ...
          taskImageOptions: {
            ...
            secrets: {
              ...
              BACKSTAGE_SECRET: ecs.Secret.fromSecretsManager(backstageSecret),
              GITLAB_ADMIN_TOKEN: ecs.Secret.fromSecretsManager(props.gitlabAdminSecret, "apiToken"),
              BACKSTAGE_HOSTNAME: ecs.Secret.fromSsmParameter(lbDNSParam),
            },
            containerPort: 8080,
            taskRole: props.taskRole,
          },
