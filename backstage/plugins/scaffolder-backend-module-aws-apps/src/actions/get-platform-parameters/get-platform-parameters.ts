...
const ID = 'aad:get-platform-parameters';

const examples = [
  {
    description: 'Retrieve AWS SSM parameter values for each environment provider so that their configurations can be used by other template actions',
    example: yaml.stringify({
      steps: [
        {
          action: ID,
          id: 'aadGetPlatformParams',
